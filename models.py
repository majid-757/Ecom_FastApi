...
class Business(Model):
    ...
    business_descriptions = fields.TextField(null=True)
...
user_paydantic = pydantic_model_creator(User, name="User", exclude=("is_verified"))
user_paydanticIn = pydantic_model_creator(User, name="UserIn", exclude_readonly=True)
user_paydanticOut = pydantic_model_creator(User, name="UserOut", exclude=("password",))


business_paydantic = pydantic_model_creator(Business, name="Business")
business_paydanticIn = pydantic_model_creator(Business, name="BusinessIn", exclude_readonly=True)


product_pydantic = pydantic_model_creator(Product, name="Product")
product_paydanticIn = pydantic_model_creator(Product, name="ProductIn" , exclude=("percentage_discount", "id"))
